    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: DateDisplay(this.selectedDate),
          ),
          SizedBox(
            width: 8.w,
          ),
...
class ShowMoneyFrame extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    Widget rowFrame(String typeName, double value, bool isPrimary) {
      return Padding(
            ...
            Expanded(
              child: Text(
                ...
                style: GoogleFonts.inter(
                  ...
                  color: isPrimary ? primaryColor : textPrimary,
                ),
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            rowFrame(this.type, typeValue, true),
            Divider(color: dividerColor, height: 24.h),
            rowFrame('Balance', balance, false),
          ],
        ),
      ),
    );
